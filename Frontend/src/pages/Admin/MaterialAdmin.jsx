...
function MaterialAdmin() {
    ...
    useEffect(() => {
        const loadCategories = async () => {
            try {
                const cats = await multimediaService.fetchCategorias('MATERIAL_EDUCATIVO');
    ...
    return (
        <div className="admin-container">
            <h1 className="admin-title">Administrar Material</h1>
            ...
            <form onSubmit={handleSubmit} className="admin-form">
                ...
                <div style={{ padding: '15px', background: '#2a2a2a', borderRadius: '8px', marginBottom: '15px' }}>
                    ...
                    {mediaType === 'image' ? (
                        <div>
                            <p style={{ margin: '0 0 5px 0', fontSize: '0.9rem' }}>Sube el archivo principal:</p>
                            <input
                                type="file"
